...
import { Shield, CheckCircle2, ArrowRight, XCircle, Briefcase, Users, FileText, Zap, BookOpen, Lock, Globe, Clock, MessageSquare, Handshake } from 'lucide-react';
...
const App = () => {
     ...
     <nav className="bg-white sticky top-0 z-50 shadow-sm border-b border-gray-100">
       <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
         ...
         <div className="hidden sm:flex gap-8">
           ...
           {/* NEW LINK: About/Contact */}
           <a onClick={() => setCurrentStep('about')} className={`text-gray-700 hover:text-blue-900 transition-colors font-semibold text-sm cursor-pointer ${currentStep === 'about' ? 'text-blue-900 border-b-2 border-blue-900' : ''}`}>About & Contact</a>
         </div>
       </div>
     </nav>
   );
   ...
   const Footer = () => (
    ...
    // --- LEGAL MANDATE SCREEN COMPONENT ---
    const LegalMandateScreen = () => (
            ...
            <main className="max-w-5xl mx-auto px-6 py-20">
                <div className="text-center mb-16">
                    ...
                    <h1 className="text-5xl font-extrabold text-blue-900 mb-4 tracking-tight">
                        The Core Legal Mandates Driving Compliance
                    </h1>
                    <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-normal">
                        Your clinic must comply with two primary federal laws concerning data protection and electronic health records. Failure is not negotiable.
                    </p>
                </div>
                ...
                <div className="bg-white p-8 md:p-12 border border-gray-100 rounded-3xl shadow-xl shadow-gray-100/70 space-y-10">
                    ...
                    <div className="border-l-4 border-blue-600 pl-6 space-y-4">
                        ...
                        <p className="text-lg text-gray-700">
                            The UAE’s overarching Personal Data Protection Law regulates the processing, storage, and cross-border transfer of all personal data. **This is the primary authority concerning data leakage via unauthorized AI use.**
                        </p>
                        <ul className="list-disc pl-5 text-gray-600 space-y-2 text-sm">
                            <li>**Cross-Border Transfer:** Using a public LLM hosted outside the UAE for patient notes constitutes an uncontrolled data transfer, a direct violation of PDPL.</li>
                            <li>**TOMS Requirement:** PDPL mandates that the Data Controller (the clinic owner) implement and document rigorous **Technical and Organisational Measures (TOMS)** to prevent leakage.</li>
                            <li>**Accountability:** Fines are applied directly to the clinic for system deficiencies, regardless of employee intent.</li>
                        </ul>
                    </div>

                    <hr className="border-gray-100" />

                    {/* Federal Law No. 2 of 2019 Section */}
                    <div className="border-l-4 border-red-600 pl-6 space-y-4">
                        <h2 className="text-3xl font-bold text-blue-900 flex items-center gap-3">
                            <Briefcase className="w-6 h-6 text-red-600" />
                            Federal Law No. 2 of 2019 (Electronic Health Data)
                        </h2>
                        <p className="text-lg text-gray-700">
                            This law specifically protects Electronic Health Data (EHD) and requires strict adherence to confidentiality and security standards (including NDHC standards).
                        </p>
                        <ul className="list-disc pl-5 text-gray-600 space-y-2 text-sm">
                            <li>**Confidentiality Mandate:** Requires the highest level of security for EHD, which includes all patient records, medical images, and administrative notes.</li>
                            <li>**AI Use & Recording:** Any device (wearable, personal app, public LLM) that handles EHD must be explicitly covered by the clinic’s security framework and consent forms.</li>
                            <li>**Fines & License Risk:** Violations compound the risk, directly jeopardizing the Medical Director's professional license in addition to large administrative fines.</li>
                        </ul>
                    </div>
                </div>
        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <main className="max-w-5xl mx-auto px-6 py-20">
                <div className="text-center mb-16">
                    ...
                    <h1 className="text-5xl font-extrabold text-blue-900 mb-4 tracking-tight">
                        About MyDataShield.org
                    </h1>
                    <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-normal">
                        We are a dedicated division of DPO Solutions, specializing in bridging the gap between cutting-edge medical technology (AI/wearables) and strict federal data compliance in the UAE.
                    </p>
                </div>

                <div className="grid md:grid-cols-2 gap-8">
                    {/* Mission */}
                    <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 space-y-4 shadow-sm">
                        <Clock className="w-8 h-8 text-blue-900" />
                        <h2 className="text-2xl font-bold text-blue-900">Our Mission</h2>
                        <p className="text-gray-700 leading-relaxed">
                            To protect UAE medical directors and clinic owners from the severe financial and professional liability risks associated with unauthorized data leakage through public AI and unchecked staff practices. We turn complex legal mandates into simple, auditable **Technical and Organisational Measures (TOMS).**
                        </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 space-y-4 shadow-sm">
                        ...
                        <h2 className="text-2xl font-bold text-blue-900">Our Expertise</h2>
                        <p className="text-gray-700 leading-relaxed">
                            We are one of the only firms providing deep expertise in **Federal Decree-Law No. 45/2021 (PDPL)** as it intersects with **Federal Law No. 2 of 2019** (EHD). Our solutions focus on implementation, staff competency tracking, and providing full regulatory documentation required for audit.
                        </p>
                    </div>
                </div>

                <div className="mt-12 bg-white p-8 rounded-2xl border border-gray-200 shadow-lg">
                    <h3 className="text-2xl font-bold text-red-600 mb-4 text-center">Contact Us</h3>
                    <div className="max-w-md mx-auto space-y-4">
                        <div className="flex items-center gap-4 text-gray-700">
                            <Zap className="w-5 h-5 text-blue-600" />
                            <p className="font-semibold">Inquiries:</p>
                            <a href="mailto:info@mydatashield.org" className="text-blue-600 hover:underline">info@mydatashield.org</a>
                        </div>
                        <div className="flex items-center gap-4 text-gray-700">
                            <MessageSquare className="w-5 h-5 text-blue-600" />
                            <p className="font-semibold">Book an Audit:</p>
                            <a onClick={() => setCurrentStep('questions')} className="text-blue-600 cursor-pointer hover:underline">Start Risk Check Now</a>
                        </div>
                    </div>
                </div>
            </main>
   ...
   // --- LEGAL MANDATE SCREEN (New Step) ---
   if (currentStep === 'legal') {
    return <LegalMandateScreen />;
   }

   // --- ABOUT US SCREEN (New Step) ---
