...
import { Shield, CheckCircle2, ArrowRight, XCircle, Briefcase, Users, FileText, Zap, BookOpen, Lock, Globe, Building } from 'lucide-react';
...
          {/* Contact (Placeholder) */}
          <a href="mailto:info@mydatashield.org" className="text-gray-700 hover:text-blue-900 transition-colors font-semibold text-sm">Contact</a>
        </div>
      </div>
    </nav>
  );
...
          <a onClick={() => setCurrentStep('legal')} className="hover:text-gray-700 transition-colors cursor-pointer">Privacy Policy</a>
...
              The Non-Negotiable Laws Governing Health Data in the UAE
            </h1>
            <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-normal">
              Ignoring these mandates creates a direct legal and financial liability for the clinic and its Medical Director.
            </p>
          </div>

          <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-2xl shadow-gray-100 border border-gray-100 space-y-10">
              
              {/* Mandate 1: PDPL */}
              <div className="border-l-4 border-blue-900 pl-6 space-y-3">
                <div className="flex items-center gap-3">
                    <Lock className="w-8 h-8 text-blue-900"/>
                    <h2 className="text-2xl font-extrabold text-blue-900">Federal Decree-Law No. 45/2021 (PDPL)</h2>
                </div>
                <p className="text-lg text-gray-700">
                  The comprehensive law on **Personal Data Protection** is the foundation for data handling in the UAE. Its mandate for **cross-border data transfer controls** is immediately violated when unprotected patient data is uploaded to foreign-hosted public Large Language Models (LLMs).
                </p>
                <ul className="text-sm text-gray-600 list-disc list-inside space-y-1 pl-4 pt-2">
                  <li>**Key Requirement:** Explicit authorization and robust safeguards for any data transfer outside the UAE.</li>
                  <li>**Risk:** Unauthorized data transfer constitutes a severe violation, leading to significant fines.</li>
                </ul>
              </div>

              <div className="h-px bg-gray-200 mx-auto w-3/4"></div>

              {/* Mandate 2: Health Data Law */}
              <div className="border-l-4 border-red-600 pl-6 space-y-3">
                <div className="flex items-center gap-3">
                    <Shield className="w-8 h-8 text-red-600"/>
                    <h2 className="text-2xl font-extrabold text-blue-900">Federal Law No. 2 of 2019 (Electronic Health Data)</h2>
                </div>
                <p className="text-lg text-gray-700">
                  This law specifically addresses the **confidentiality and security of Electronic Health Data (EHD)**. It places a direct, non-delegable duty on healthcare providers to protect this sensitive information through **auditable security measures**.
                </p>
                <ul className="text-sm text-gray-600 list-disc list-inside space-y-1 pl-4 pt-2">
                  <li>**Key Requirement:** Implement and maintain technical and administrative controls (TOMS) to ensure data confidentiality.</li>
                  <li>**Risk:** Failure to implement TOMS is grounds for regulatory sanctions, including license suspension.</li>
                </ul>
              </div>
            </div>
...
              <button
                onClick={() => setCurrentStep('questions')}
                className="inline-flex items-center gap-4 bg-blue-900 text-white px-10 py-5 rounded-xl font-extrabold text-lg shadow-lg shadow-blue-900/30 transition-all duration-300 hover:bg-blue-800 hover:-translate-y-0.5"
              >
...
          <div className="text-center mb-16">
            <h1 className="text-5xl font-extrabold text-blue-900 mb-4 tracking-tight">
              Securing the Future of Regulated AI in Healthcare
            </h1>
            <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-normal">
              MyDataShield.org is powered by DPO Solutions, dedicated to achieving auditable, state-level compliance for medical professionals.
            </p>
          </div>

          <div className="max-w-4xl mx-auto bg-gray-50 p-8 md:p-12 rounded-3xl shadow-xl shadow-gray-100/70 space-y-8 border border-gray-200">
            <h2 className="text-3xl font-bold text-red-600 border-b border-gray-200 pb-4 flex items-center gap-3">
              <Building className="w-8 h-8"/> Our Mission
            </h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              In the rapidly evolving landscape of digital health, compliance is not just about avoiding fines—it's about **safeguarding patient trust and professional integrity**. Our mission is to provide the **Technical and Organisational Measures (TOMS)** required by the UAE's Federal Decree-Law No. 45/2021 (PDPL) and the National Unified Health Data System (NDHC).
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              We believe that medical innovation using AI can only thrive within a framework of **strict data sovereignty and auditable governance**. We bridge the gap between emerging AI tools and non-negotiable regulatory demands.
            </p>

            <h2 className="text-3xl font-bold text-blue-900 border-b border-gray-200 pt-6 pb-4 flex items-center gap-3">
              <Users className="w-8 h-8"/> Why Partner with Us?
            </h2>
...
                  <div>
                    <h3 className="font-bold text-xl text-gray-900">Focused Expertise</h3>
                    <p className="text-sm text-gray-600 mt-1">Specializing exclusively in UAE healthcare data compliance (PDPL, NDHC, ADHICS) and AI/LLM risk mitigation.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-md">
                  <FileText className="w-6 h-6 text-red-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-xl text-gray-900">Audit-Ready Documentation</h3>
                    <p className="text-sm text-gray-600 mt-1">We deliver the complete, legally reviewed documentation required to pass regulatory inspections.</p>
                  </div>
                </div>
            </div>
          </div>
